...
<script type="text/javascript">
    function showPR() {
        const popUrl = "${pageContext.request.contextPath}/view/accomodationPayment/RegisterAccomodationPayment.jsp";
    ...
    function showPM() {
        const popUrl = "${pageContext.request.contextPath}/view/accomodationPayment/ModifyAccomodationPayment.jsp";
        const leftPosition = (window.screen.width-500)/2;
        const topPosition = (window.screen.height-400)/2;
        const popOption = "width=500, height=400, top="+topPosition+", left="+leftPosition+", resizable=no, scrollbars=no, status=no, menubar=no, toolbar=no, location=no;";
        window.open(popUrl,"",popOption);
    ...
    function showPD() {
        const popUrl = "${pageContext.request.contextPath}/view/accomodationPayment/DeleteAccomodationPayment.jsp";
        const leftPosition = (window.screen.width-500)/2;
        const topPosition = (window.screen.height-400)/2;
        const popOption = "width=500, height=400, top="+topPosition+", left="+leftPosition+", resizable=no, scrollbars=no, status=no, menubar=no, toolbar=no, location=no;";
        window.open(popUrl,"",popOption);
