...
@WebServlet("/reqRegisterAccommodationPayment")
public class RegisterAccommodationPayment extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        {
            printAlert("이미 있는 결제정보 입니다",resp);
        }
        ...
        resp.sendRedirect("/view/AccommodationPayment/accommodationPaymentRegister.jsp");
    }
