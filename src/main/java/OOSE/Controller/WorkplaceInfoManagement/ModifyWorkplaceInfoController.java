...
public class ModifyWorkplaceInfoController extends HttpServlet {
    ...
    private void workplaceInfoModify(HttpServletRequest req, HttpServletResponse resp){
        ...
        if(result == true){htmlPrint(resp, "수정 성공");}
        else{htmlPrint(resp, "수정 실패");}
    }
