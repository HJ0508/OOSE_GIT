    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            if(req.getParameter("condition").equals("예약"))
                dispatcher = req.getRequestDispatcher("/view/reservation/registerReservationPopup.jsp");
            else
                dispatcher = req.getRequestDispatcher("/view/reservation/registerReservationCancelPopup.jsp");
